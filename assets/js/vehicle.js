(function () {
  ...
  function renderVehicle() {
    ...
    var specs = [["Category", vehicle.category], ["Passengers", vehicle.seats + " seats"], ["Doors", vehicle.doors], ["Transmission", vehicle.transmission], ["Fuel", vehicle.fuel], ["Mileage allowance", vehicle.mileage], ["Minimum driver age", vehicle.minimumAge + "+ years"], ["Refundable deposit", formatNaira(vehicle.deposit)]];
    host.innerHTML =
